...
export function getBrandBadgeHtml(brand, isSelected = false, size = 'sm') {
  ...
  // HYUNDAI - Authentic Official Slanted Oval with Italic 'H' Emblem SVG
  if (id === 'hyundai' || name.includes('hyundai')) {
    return `
      <span class="${sizeClass} rounded-md bg-[#002c5f] border border-sky-500/50 text-white flex items-center justify-center p-0.5 shadow-sm" title="Hyundai">
